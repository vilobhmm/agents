    ...
    def get_all_agents() -> List[AgentEntry]:
        ...
        return [
            ...
            AgentEntry(
                ...
                module_path="agents.career.career_coordinator",
                class_name="CareerCoordinator",
                category="career",
                description="Top-level coordinator for all career role agents",
                deterministic_methods=["list_roles"],
            ),
            AgentEntry(
                name="Product Manager Agent",
                module_path="agents.career.product_manager.pm_coordinator",
                class_name="ProductManagerAgent",
                category="career",
                description="Full-spectrum PM: strategy, research, prioritization, launch",
                deterministic_methods=["get_skill_dimensions"],
            ),
            AgentEntry(
                name="PM Prioritization",
                module_path="agents.career.product_manager.prioritization",
                class_name="PMPrioritization",
                category="career",
                description="RICE, ICE, MoSCoW, Kano, opportunity scoring frameworks",
            ),
            AgentEntry(
                name="PM Skills",
                module_path="agents.career.product_manager.pm_skills",
                class_name="PMSkills",
                category="career",
                description="PM skills rubric with 7 competency dimensions",
                deterministic_methods=["get_dimensions"],
            ),
            AgentEntry(
                name="Software Engineer Agent",
                module_path="agents.career.software_engineer.swe_coordinator",
                class_name="SoftwareEngineerAgent",
                category="career",
                description="SWE IC: design, code review, quality, tech debt",
                deterministic_methods=["get_skill_dimensions"],
            ),
            AgentEntry(
                name="SWE Skills",
                module_path="agents.career.software_engineer.swe_skills",
                class_name="SWESkills",
                category="career",
                description="SWE skills rubric with L3-L8 style ladder",
                deterministic_methods=["get_dimensions"],
            ),
            AgentEntry(
                name="Research Scientist Agent",
                module_path="agents.career.research_scientist.scientist_coordinator",
                class_name="ResearchScientistAgent",
                category="career",
                description="Research: literature, experiments, publication, grants",
                deterministic_methods=["get_skill_dimensions"],
            ),
            AgentEntry(
                name="Scientist Skills",
                module_path="agents.career.research_scientist.scientist_skills",
                class_name="ScientistSkills",
                category="career",
                description="Scientist skills rubric with 7 research dimensions",
                deterministic_methods=["get_dimensions"],
            ),
            AgentEntry(
                name="Tech Lead Manager Agent",
                module_path="agents.career.tech_lead_manager.tlm_coordinator",
                class_name="TechLeadManagerAgent",
                category="career",
                description="TLM: technical leadership + people management",
                deterministic_methods=["get_skill_dimensions"],
            ),
            AgentEntry(
                name="TLM Skills",
                module_path="agents.career.tech_lead_manager.tlm_skills",
                class_name="TLMSkills",
                category="career",
                description="TLM dual-track rubric: technical + people dimensions",
                deterministic_methods=["get_dimensions"],
            ),
            AgentEntry(
                name="Skills Engine",
                module_path="agents.career.base.skills_engine",
                class_name="SkillsEngine",
                category="career",
                description="AI-powered skills assessment engine used by all roles",
            ),
            AgentEntry(
                name="Growth Tracker",
                module_path="agents.career.base.growth_tracker",
                class_name="GrowthTracker",
                category="career",
                description="Skill growth tracking with snapshot persistence",
            ),
        ]
