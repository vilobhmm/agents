...
from core.agent_tools.job_scraper import JobScraper, search_jobs, get_company_jobs
from core.agent_tools.universal_job_scraper import UniversalJobScraper, search_jobs_universal
